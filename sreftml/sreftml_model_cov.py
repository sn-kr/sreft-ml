    ...
    def call(
        ...
        **kwargs,
        ...
        Returns:
            ...
            :param **kwargs:
        """
        (input_x, input_cov1, input_cov2, input_m, input_y) = inputs
        input1 = tf.concat((input_m, input_cov1), axis=-1, name="concat")
        ...
        input2 = tf.concat((dis_time, input_cov2), axis=-1, name="concat")
